...
def get_args_parser():
    ...
    parser.add_argument('--order_sem_weight', default=0.5, type=float)
    ...
    # ---- V4: curvature-aware semantic part token ----
    parser.add_argument('--num-parts', default=8, type=int)
    parser.add_argument('--part-aux-weight', default=0.1, type=float)
    parser.add_argument('--lam-cls', default=0.5, type=float)
    parser.add_argument('--lam-attr', default=0.5, type=float)
    parser.add_argument('--global-align-weight', default=0.0, type=float)
